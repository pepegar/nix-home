...
let
  ...
  google-auth-oauthlib =
    pkgs.python37Packages.google-auth-oauthlib.overridePythonAttrs (old: rec {
      propagatedBuildInputs =
        [ google-auth-1-10-0 pkgs.python37Packages.requests_oauthlib ];
    });
  googleapis_common_protos =
    pkgs.python37Packages.googleapis_common_protos.overridePythonAttrs
    (old: rec {
      version = "1.51.0";
      src = fetchPypi {
  ...
  google_api_core = pkgs.python37Packages.google_api_core.overridePythonAttrs
    (old: rec {
      version = "1.16.0";
      src = fetchPypi {
  ...
  google_cloud_core =
    pkgs.python37Packages.google_cloud_core.overridePythonAttrs (old: rec {
      version = "1.3.0";
      src = fetchPypi {
  ...
  google_resumable_media =
    pkgs.python37Packages.google_resumable_media.overridePythonAttrs (old: rec {
      version = "0.5.0";
      src = fetchPypi {
  ...
  google_cloud_bigquery =
    pkgs.python37Packages.google_cloud_bigquery.overridePythonAttrs (old: rec {
      version = "1.22.0";
      src = fetchPypi {
      ...
      propagatedBuildInputs =
        [ google-auth-1-10-0 google_resumable_media google_cloud_core ];
      doCheck = false;
    });
  pydata-google-auth = buildPythonPackage rec {
    ...
    src = pkgs.fetchurl {
      url =
        "https://github.com/pydata/pydata-google-auth/releases/download/0.3.0/pydata-google-auth-0.3.0.tar.gz";
  ...
  pandas-gbq = buildPythonPackage rec {
    ...
    src = pkgs.fetchurl {
      url =
        "https://github.com/pydata/pandas-gbq/archive/e177978227c9a42e3c63a864616c6ac7d98f2840.tar.gz";
  ...
  tf-bin = pkgs.python3Packages.tensorflow-bin.overridePythonAttrs
    (old: rec { cudaSupport = true; });
  ...
  myJupyter = jupyter.override {
    definitions = {
      ...
      python3 = {
        ...
        language = "python";
        logo32 =
          "${myPythonEnv.sitePackages}/ipykernel/resources/logo-32x32.png";
        logo64 =
          "${myPythonEnv.sitePackages}/ipykernel/resources/logo-64x64.png";
      };
    };
  };
  ...
  myJupyterEnv = python37.buildEnv.override {
    extraLibs = [ myJupyter myIpywidgets myWidgetsnbextension ];
  };
in {
