...
myFocusedBorderColor = "#ff7700"      -- color of focused border
myNormalBorderColor  = "#cccccc"      -- color of inactive border
myBorderWidth        = 6              -- width of border around windows
mySpacing            = 5              -- spacing between windows
...
defaultLayouts = smartBorders $ avoidStruts $
  ...
  -- "super-l".
  spacing mySpacing $ ResizableTall 1 (3/100) (1/2) []
...
main = xmonad . docks . ewmh . pagerHints $ withUrgencyHook NoUrgencyHook $ def {
